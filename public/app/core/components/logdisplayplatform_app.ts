...
export class LogDisplayPlatformCtrl {
  /** @ngInject */
  constructor(
    $scope,
    alertSrv,
...
/** @ngInject */
export function logdisplayplatformAppDirective(playlistSrv, contextSrv, $timeout, $rootScope, $location) {
  return {
    restrict: 'E',
    controller: LogDisplayPlatformCtrl,
    link: (scope, elem) => {
      var sidemenuOpen;
      var body = $('body');
...
coreModule.directive('logdisplayplatformApp', logdisplayplatformAppDirective);
