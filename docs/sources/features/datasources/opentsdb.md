+++
title = "Using OpenTSDB in LogDisplayPlatform"
description = "Guide for using OpenTSDB in LogDisplayPlatform"
keywords = ["logdisplayplatform", "opentsdb", "guide"]
type = "docs"
...
# Using OpenTSDB in LogDisplayPlatform

LogDisplayPlatform ships with advanced support for OpenTSDB.
...
LogDisplayPlatform's OpenTSDB data source supports template variable queries. This means you can create template variables
