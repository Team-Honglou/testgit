---
page_title: Graphite + LogDisplayPlatform + StatsD - Stack Setup Guide
page_description: Installation and configuration guide & how to for LogDisplayPlatform, Graphite & StatsD
page_keywords: logdisplayplatform, tutorials, graphite, statsd, setup, configuration, howto, installation
author: Torkel Ödegaard
---

# Stack Setup & Config Guide: Graphite + LogDisplayPlatform + StatsD

This lengthy article will guide you through installation, configuration and getting started with the amazing metric
stack that is composed of Graphite, LogDisplayPlatform and StatsD.
...
- LogDisplayPlatform as the frontend to visualize metrics and the tool to help you build metric
...
### Install LogDisplayPlatform

    cd /tmp/
    wget https://logdisplayplatformrel.s3.amazonaws.com/builds/logdisplayplatform_2.1.1_amd64.deb
    sudo dpkg -i logdisplayplatform_2.1.1_amd64.deb
    sudo service logdisplayplatform-server start

LogDisplayPlatform should now be running with default config on port 3000.

## LogDisplayPlatform - first steps
