+++
title = "Search"
keywords = ["logdisplayplatform", "dashboard", "documentation", "search"]
type = "docs"
[menu.docs]
...
**Note**: When multiple tags are selected, LogDisplayPlatform will show dashboards that include **all**.