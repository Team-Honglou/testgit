...
export class IntervalVariable implements Variable {
  ...
  updateAutoValue() {
    ...
    this.templateSrv.setLogDisplayPlatformVariable('$__auto_interval_' + this.name, res.interval);
    // for backward compatibility, to be removed eventually
    this.templateSrv.setLogDisplayPlatformVariable('$__auto_interval', res.interval);
  }
