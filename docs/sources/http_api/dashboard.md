...
description = "LogDisplayPlatform Dashboard HTTP API"
keywords = ["logdisplayplatform", "http", "documentation", "api", "dashboard"]
...
The identifier (id) of a dashboard is an auto-incrementing numeric value and is only unique per LogDisplayPlatform install.

The unique identifier (uid) of a dashboard can be used for uniquely identify a dashboard between multiple LogDisplayPlatform installs.
...
dashboards and when syncing dashboards between multiple LogDisplayPlatform installs, see [dashboard provisioning](/administration/provisioning/#dashboards)
...

{
  ...
  "status":  "success",
  "version": 1,
  "slug":    "production-overview" //deprecated in LogDisplayPlatform v5.0
}
```
...
**Deprecated starting from LogDisplayPlatform v5.0. Please update to use the new *Get dashboard by uid* resource instead**
...
**Deprecated starting from LogDisplayPlatform v5.0. Please update to use the *Delete dashboard by uid* resource instead.**
