...
import (
	...
	"github.com/logdisplayplatform/logdisplayplatform/pkg/services/annotations"
	"github.com/logdisplayplatform/logdisplayplatform/pkg/services/sqlstore/migrations"
	"github.com/logdisplayplatform/logdisplayplatform/pkg/services/sqlstore/migrator"
	...
	_ "github.com/logdisplayplatform/logdisplayplatform/pkg/tsdb/mssql"
	_ "github.com/lib/pq"
...
func (ss *SqlStore) readConfig() {
	...
	ss.dbCfg.Path = sec.Key("path").MustString("data/logdisplayplatform.db")
}
