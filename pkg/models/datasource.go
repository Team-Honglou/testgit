...
var knownDatasourcePlugins = map[string]bool{
	...
	"newrelic-app":                        true,
	"logdisplayplatform-datadog-datasource":          true,
	"logdisplayplatform-simple-json":                 true,
	"logdisplayplatform-splunk-datasource":           true,
	"udoprog-heroic-datasource":           true,
	"logdisplayplatform-openfalcon-datasource":       true,
