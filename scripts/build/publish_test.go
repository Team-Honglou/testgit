...
var testData = []testPackage{
	{
		path:    "logdisplayplatform-5.2.0-474pre1.aarch64.rpm",
		version: "5.2.0-474pre1",
		os:      "rhel",
		arch:    "arm64",
	},
	{
		path:    "logdisplayplatform-5.2.0-474pre1.armhfp.rpm",
		version: "5.2.0-474pre1",
		os:      "rhel",
		arch:    "armv7",
	},
	{
		path:    "logdisplayplatform-5.2.0-474pre1.darwin-amd64.tar.gz",
		version: "5.2.0-474pre1",
		os:      "darwin",
		arch:    "amd64",
	},
	{
		path:    "logdisplayplatform-5.2.0-474pre1.linux-amd64.tar.gz",
		version: "5.2.0-474pre1",
		os:      "linux",
		arch:    "amd64",
	},
	{
		path:    "logdisplayplatform-5.2.0-474pre1.linux-arm64.tar.gz",
		version: "5.2.0-474pre1",
		os:      "linux",
		arch:    "arm64",
	},
	{
		path:    "logdisplayplatform-5.2.0-474pre1.linux-armv7.tar.gz",
		version: "5.2.0-474pre1",
		os:      "linux",
		arch:    "armv7",
	},
	{
		path:    "logdisplayplatform-5.2.0-474pre1.windows-amd64.zip",
		version: "5.2.0-474pre1",
		os:      "win",
		arch:    "amd64",
	},
	{
		path:    "logdisplayplatform-5.2.0-474pre1.x86_64.rpm",
		version: "5.2.0-474pre1",
		os:      "rhel",
		arch:    "amd64",
	},
	{
		path:    "logdisplayplatform_5.2.0-474pre1_amd64.deb",
		version: "5.2.0-474pre1",
		os:      "deb",
		arch:    "amd64",
	},
	{
		path:    "logdisplayplatform_5.2.0-474pre1_arm64.deb",
		version: "5.2.0-474pre1",
		os:      "deb",
		arch:    "arm64",
	},
	{
		path:    "logdisplayplatform_5.2.0-474pre1_armhf.deb",
		version: "5.2.0-474pre1",
		os:      "deb",
		arch:    "armv7",
	},
...
func TestFileWalker(t *testing.T) {
	...
	incorrectPackageName := "logdisplayplatform_5.2.0-474pre1_armfoo.deb"
