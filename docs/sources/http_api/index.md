...
keywords = ["logdisplayplatform", "http", "documentation", "api", "overview"]
type = "docs"
[menu.docs]
name = "HTTP API"
identifier = "http_api"
...
The LogDisplayPlatform backend exposes an HTTP API, the same API is used by the frontend to do everything from saving
