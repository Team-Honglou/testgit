...
<div class="modal-body">
  ...
  <div class="modal-content">
    <small>
      This dashboard cannot be saved from LogDisplayPlatform's UI since it has been provisioned from another source.
      Copy the JSON or save it to a file below. Then you can update your dashboard in corresponding provisioning source.<br/>
      <i>See <a class="external-link" href="http://docs.logdisplayplatform.org/administration/provisioning/#dashboards" target="_blank">
