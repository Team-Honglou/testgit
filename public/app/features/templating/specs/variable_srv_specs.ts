...
describe('VariableSrv', function() {
  ...
  describeUpdateVariable('interval variable with auto', scenario => {
    scenario.setup(() => {
      ...
      ctx.templateSrv.setLogDisplayPlatformVariable = sinon.spy();
    });
    ...
    it('should set $__auto_interval_test', function() {
      var call = ctx.templateSrv.setLogDisplayPlatformVariable.firstCall;
    ...
    it('should set $__auto_interval', function() {
      var call = ctx.templateSrv.setLogDisplayPlatformVariable.lastCall;
  ...
  describe('multiple interval variables with auto', function() {
    ...
    it('should correctly set $__auto_interval_variableX', function() {
      ...
      for (var i = 0; i < ctx.templateSrv.setLogDisplayPlatformVariable.callCount; i++) {
        var call = ctx.templateSrv.setLogDisplayPlatformVariable.getCall(i);
        switch (call.args[0]) {
