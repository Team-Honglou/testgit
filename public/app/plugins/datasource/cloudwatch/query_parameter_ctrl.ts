...
angular.module('logdisplayplatform.controllers').directive('cloudwatchQueryParameter', CloudWatchQueryParameter);
angular.module('logdisplayplatform.controllers').controller('CloudWatchQueryParameterCtrl', CloudWatchQueryParameterCtrl);
