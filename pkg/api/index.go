...
func setIndexViewData(c *m.ReqContext) (*dtos.IndexViewData, error) {
	...
	var data = dtos.IndexViewData{
		User: &dtos.CurrentUser{
			...
			IsLogDisplayPlatformAdmin:             c.IsLogDisplayPlatformAdmin,
	...
	if hasEditPermissionInFoldersQuery.Result {
		...
		children = append(children, &dtos.NavLink{Text: "Import", SubTitle: "Import dashboard from file or LogDisplayPlatform.com", Id: "import", Icon: "gicon gicon-dashboard-import", Url: setting.AppSubUrl + "/dashboard/import"})
	...
	if c.IsLogDisplayPlatformAdmin || c.OrgRole == m.ROLE_ADMIN {
		...
		if c.OrgRole == m.ROLE_ADMIN && c.IsLogDisplayPlatformAdmin {
			cfgNode.Children = append(cfgNode.Children, &dtos.NavLink{
				Divider: true, HideFromTabs: true, Id: "admin-divider", Text: "Text",
			})
		}

		if c.IsLogDisplayPlatformAdmin {
			cfgNode.Children = append(cfgNode.Children, &dtos.NavLink{
				Text:         "Server Admin",
				HideFromTabs: true,
	...
	data.NavTree = append(data.NavTree, &dtos.NavLink{
		...
		Children: []*dtos.NavLink{
			...
			{Text: "Community site", Url: "http://community.logdisplayplatform.com", Icon: "fa fa-fw fa-comment", Target: "_blank"},
			{Text: "Documentation", Url: "http://docs.logdisplayplatform.org", Icon: "fa fa-fw fa-file", Target: "_blank"},
		},
	})
