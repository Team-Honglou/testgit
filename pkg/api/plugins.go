...
func GetPluginList(c *m.ReqContext) Response {
	...
	for _, pluginDef := range plugins.Plugins {
		...
		listItem := dtos.PluginListItem{
			...
			Type:          pluginDef.Type,
			Info:          &pluginDef.Info,
			LatestVersion: pluginDef.LogDisplayPlatformNetVersion,
			HasUpdate:     pluginDef.LogDisplayPlatformNetHasUpdate,
...
func GetPluginSettingByID(c *m.ReqContext) Response {
	...
	dto := &dtos.PluginSetting{
		...
		LatestVersion: def.LogDisplayPlatformNetVersion,
		HasUpdate:     def.LogDisplayPlatformNetHasUpdate,
		State:         def.State,
	}
