+++
title = "LogDisplayPlatform documentation"
...
# LogDisplayPlatform Documentation

<h2>Installing LogDisplayPlatform</h2>
<div class="nav-cards">
    ...
    <a href="https://logdisplayplatform.com/cloud/logdisplayplatform" class="nav-cards__item nav-cards__item--install">
        <div class="nav-cards__icon fa fa-cloud">
        </div>
        <h5>LogDisplayPlatform Cloud</h5>
    </a>
    <a href="https://logdisplayplatform.com/logdisplayplatform/download" class="nav-cards__item nav-cards__item--install">
...
<div class="nav-cards">
    <a href="https://logdisplayplatform.com/logdisplayplatform" class="nav-cards__item nav-cards__item--guide">
        <h4>What is LogDisplayPlatform?</h4>
        <p>LogDisplayPlatform feature highlights.</p>
    </a>
    <a href="{{< relref "installation/configuration.md" >}}" class="nav-cards__item nav-cards__item--guide">
        <h4>Configure LogDisplayPlatform</h4>
        <p>Article on all the LogDisplayPlatform configuration and setup options.</p>
    </a>
    <a href="{{< relref "guides/getting_started.md" >}}" class="nav-cards__item nav-cards__item--guide">
        <h4>Getting Started</h4>
        <p>A guide that walks you through the basics of using LogDisplayPlatform</p>
    </a>
    <a href="{{< relref "administration/provisioning.md" >}}" class="nav-cards__item nav-cards__item--guide">
        <h4>Provisioning</h4>
        <p>A guide to help you automate your LogDisplayPlatform setup & configuration.</p>
    </a>
