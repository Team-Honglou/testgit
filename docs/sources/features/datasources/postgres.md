+++
title = "Using PostgreSQL in LogDisplayPlatform"
description = "Guide for using PostgreSQL in LogDisplayPlatform"
keywords = ["logdisplayplatform", "postgresql", "guide"]
type = "docs"
[menu.docs]
name = "PostgreSQL"
parent = "datasources"
...
# Using PostgreSQL in LogDisplayPlatform
...
```sql
 ...
 GRANT USAGE ON SCHEMA schema TO logdisplayplatformreader;
 GRANT SELECT ON schema.table TO logdisplayplatformreader;
```
