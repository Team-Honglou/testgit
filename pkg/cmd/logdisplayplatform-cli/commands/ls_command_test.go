...
import (
	"errors"
	"github.com/logdisplayplatform/logdisplayplatform/pkg/cmd/logdisplayplatform-cli/commands/commandstest"
	s "github.com/logdisplayplatform/logdisplayplatform/pkg/cmd/logdisplayplatform-cli/services"
	...
	Convey("ls command", t, func() {
		...
		Convey("Path is not a directory", func() {
			commandLine := &commandstest.FakeCommandLine{
				...
				GlobalFlags: &commandstest.FakeFlagger{
					Data: map[string]interface{}{
						"path": "/var/lib/logdisplayplatform/plugins",
					},
				},
			}
