+++
title = "What's New in LogDisplayPlatform v2.5"
description = "Feature & improvement highlights for LogDisplayPlatform v2.5"
keywords = ["logdisplayplatform", "new", "documentation", "2.5"]
type = "docs"
+++

# What's new in LogDisplayPlatform v2.5

## Release highlights
This is an exciting release, and we want to share some of the highlights. The release includes many
fixes and enhancements to all areas of LogDisplayPlatform, like new Data Sources, a new and improved timepicker, user invites, panel
...
Try the new Elasticsearch query editor on the [play.logdisplayplatform.org](http://play.logdisplayplatform.org/dashboard/db/elasticsearch-metrics) site.

### CloudWatch

<img src="/img/docs/whatsnew_2_5/cloudwatch.png" alt="Cloudwatch editor">

LogDisplayPlatform 2.5 ships with a new CloudWatch datasource that will allow you to query and visualize CloudWatch
metrics directly from LogDisplayPlatform.
...
LogDisplayPlatform 2.5 ships with a new Prometheus datasource that will allow you to query and visualize data
...
- Check out [#2353](https://github.com/logdisplayplatform/logdisplayplatform/issues/2353) for more info.
...
### <a href="https://logdisplayplatform.com/get">Download LogDisplayPlatform 2.5 now</a>
