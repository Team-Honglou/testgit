...
angular.module('logdisplayplatform.directives').directive('dashLinksContainer', dashLinksContainer);
angular.module('logdisplayplatform.directives').directive('dashLink', dashLink);
angular.module('logdisplayplatform.directives').controller('DashLinksContainerCtrl', DashLinksContainerCtrl);
