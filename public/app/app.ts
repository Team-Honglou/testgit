...
export class LogDisplayPlatformApp {
  ...
  init() {
    var app = angular.module('logdisplayplatform', []);
    ...
    _.each(module_types, type => {
      var moduleName = 'logdisplayplatform.' + type;
...
export default new LogDisplayPlatformApp();
