+++
title = "What's New in LogDisplayPlatform v2.1"
description = "Feature & improvement highlights for LogDisplayPlatform v2.1"
keywords = ["logdisplayplatform", "new", "documentation", "2.1"]
type = "docs"
+++

# What's new in LogDisplayPlatform v2.1
LogDisplayPlatform 2.1 brings improvements in three core areas: dashboarding, authentication, and data sources.
As with every LogDisplayPlatform release, there is a whole slew of new features, enhancements, and bug fixes.

## More Dynamic Dashboards
The Templating system is one of the most powerful and well-used features of LogDisplayPlatform.
...
LogDisplayPlatform can now index Dashboards saved locally as JSON from a given directory. These file based dashboards
...
### LDAP support
This highly requested feature now allows your LogDisplayPlatform users to login with their LDAP credentials.
You can also specify mappings between LDAP group memberships and LogDisplayPlatform Organization user roles.

### Basic Auth Support
You can now authenticate against the LogDisplayPlatform API utilizing a simple username and password with basic HTTP authentication.
...
There is a new User role available in this version of LogDisplayPlatform: “Read-only Editor”. This role behaves just
like the Viewer role does in LogDisplayPlatform 2.0.  That is you can edit graphs and queries but not save dashboards.
The Viewer role has been modified in LogDisplayPlatform 2.1 so that users assigned this role can no longer edit panels.
...
LogDisplayPlatform 2.1 now comes with full support for InfluxDB 0.9. There is a new query editor designed from scratch
...
LogDisplayPlatform OpenTSDB data source now supports template variable values queries. This means you can create
...
The Cassandra backed time series database KairosDB is now supported in LogDisplayPlatform out of the box. Thank you to
...
LogDisplayPlatform 2.1 gives you even more flexibility customizing how individual panels render.
...
view the [CHANGELOG.md](https://github.com/logdisplayplatform/logdisplayplatform/blob/master/CHANGELOG.md) file.
