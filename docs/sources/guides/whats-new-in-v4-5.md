+++
title = "What's New in LogDisplayPlatform v4.5"
description = "Feature & improvement highlights for LogDisplayPlatform v4.5"
keywords = ["logdisplayplatform", "new", "documentation", "4.5"]
type = "docs"
[menu.docs]
name = "Version 4.5"
identifier = "v4.5"
...
# What's New in LogDisplayPlatform v4.5
...
More information [here](https://community.logdisplayplatform.com/t/using-logdisplayplatforms-query-inspector-to-troubleshoot-issues/2630).
