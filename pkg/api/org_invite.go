...
import (
	...
	"github.com/logdisplayplatform/logdisplayplatform/pkg/events"
...
func inviteExistingUserToOrg(c *m.ReqContext, user *m.User, inviteDto *dtos.AddInviteForm) Response {
	...
	return Success(fmt.Sprintf("Existing LogDisplayPlatform user %s added to org %s", user.NameOrFallback(), c.OrgName))
}
