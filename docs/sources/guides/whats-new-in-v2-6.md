+++
title = "What's New in LogDisplayPlatform v2.6"
description = "Feature & improvement highlights for LogDisplayPlatform v2.6"
keywords = ["logdisplayplatform", "new", "documentation", "2.6"]
type = "docs"
+++

# What's new in LogDisplayPlatform v2.6
...
how many data points are fetched, etc. The time series aggregations are calculated by LogDisplayPlatform after aggregation is performed
...
If you have Elasticsearch 2.x and LogDisplayPlatform 2.6 or above then you can use pipeline metric aggregations like
...
<a href="http://logdisplayplatform.org/download">Download LogDisplayPlatform 2.6 now</a>
