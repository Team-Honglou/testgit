+++
title = "Using Elasticsearch in LogDisplayPlatform"
description = "Guide for using Elasticsearch in LogDisplayPlatform"
keywords = ["logdisplayplatform", "elasticsearch", "guide"]
type = "docs"
...
# Using Elasticsearch in LogDisplayPlatform

LogDisplayPlatform ships with advanced support for Elasticsearch. You can do many types of simple or complex Elasticsearch queries to
...
options are enabled, LogDisplayPlatform converts the labels from plain text to a lucene compatible condition.
...
queries via the Dashboard menu / Annotations view. LogDisplayPlatform can query any Elasticsearch index
