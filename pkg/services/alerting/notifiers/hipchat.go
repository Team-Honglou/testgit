	...
	alerting.RegisterNotifier(&alerting.NotifierPlugin{
      ...
      <h3 class="page-heading">HipChat settings</h3>
			      <div class="gf-form max-width-30">
			        ...
			        <input type="text" required class="gf-form-input max-width-30" ng-model="ctrl.model.settings.url" placeholder="HipChat URL (ex https://logdisplayplatform.hipchat.com)"></input>
			      </div>
      <div class="gf-form max-width-30">
...
func (this *HipChatNotifier) Notify(evalContext *alerting.EvalContext) error {
	...
	card := map[string]interface{}{
		...
		"icon": map[string]interface{}{
			"url": "https://logdisplayplatform.com/assets/img/fav32.png",
		},
