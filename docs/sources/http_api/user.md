+++
title = "User HTTP API "
description = "LogDisplayPlatform User HTTP API"
keywords = ["logdisplayplatform", "http", "documentation", "api", "user"]
...
Default value for the `perpage` parameter is `1000` and for the `page` parameter is `1`. Requires basic authentication and that the authenticated user is a LogDisplayPlatform Admin.
...
Requires basic authentication and that the authenticated user is a LogDisplayPlatform Admin.
...
Switch user context to the given organization. Requires basic authentication and that the authenticated user is a LogDisplayPlatform Admin.
