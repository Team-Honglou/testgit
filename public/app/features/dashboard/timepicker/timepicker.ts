...
angular.module('logdisplayplatform.directives').directive('gfTimePickerSettings', settingsDirective);
angular.module('logdisplayplatform.directives').directive('gfTimePicker', timePickerDirective);

import { inputDateDirective } from './input_date';
angular.module('logdisplayplatform.directives').directive('inputDatetime', inputDateDirective);
