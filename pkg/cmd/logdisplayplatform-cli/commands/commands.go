...
func runPluginCommand(command func(commandLine CommandLine) error) func(context *cli.Context) {
	return func(context *cli.Context) {
		...
		if err := command(cmd); err != nil {
			...
			logger.Info("\nRestart logdisplayplatform after installing plugins . <service logdisplayplatform-server restart>\n\n")
		}
	}
}
...
var adminCommands = []cli.Command{
	{
		...
		Flags: []cli.Flag{
			cli.StringFlag{
				Name:  "homepath",
				Usage: "path to logdisplayplatform install/home path, defaults to working directory",
			},
			cli.StringFlag{
				Name:  "config",
...
var Commands = []cli.Command{
	{
		Name:        "plugins",
		Usage:       "Manage plugins for logdisplayplatform",
		Subcommands: pluginCommands,
	},
	{
		Name:        "admin",
		Usage:       "LogDisplayPlatform admin commands",
