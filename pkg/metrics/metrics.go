...
const exporterName = "logdisplayplatform"
...
var (
	...
	M_LogDisplayPlatform_Version        *prometheus.GaugeVec
)
...
func init() {
	...
	M_LogDisplayPlatform_Version = prometheus.NewGaugeVec(prometheus.GaugeOpts{
		Name:      "info",
		Help:      "Information about the LogDisplayPlatform",
		Namespace: exporterName,
	}, []string{"version"})
}
...
var usageStatsURL = "https://stats.logdisplayplatform.org/logdisplayplatform-usage-report"
...
func sendUsageStats() {
	...
	metricsLogger.Debug("Sending anonymous usage stats to stats.logdisplayplatform.org")
