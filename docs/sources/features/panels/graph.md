+++
title = "Graph Panel"
keywords = ["logdisplayplatform", "graph panel", "documentation", "guide", "graph"]
type = "docs"
...
The main panel in LogDisplayPlatform is simply named Graph. It provides a very rich set of graphing options.
...
The legend values are calculated client side by LogDisplayPlatform and depend on what type of
...
It is just the sum of all data points received by LogDisplayPlatform.
