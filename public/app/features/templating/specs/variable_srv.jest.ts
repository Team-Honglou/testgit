...
describe('VariableSrv', function() {
  var ctx = <any>{
    ...
    templateSrv: {
      setLogDisplayPlatformVariable: jest.fn(),
      init: vars => {
        this.variables = vars;
      },
      updateTemplateData: () => {},
  ...
  describeUpdateVariable('interval variable with auto', scenario => {
    scenario.setup(() => {
      ...
      //   ctx.templateSrv.setLogDisplayPlatformVariable = jest.fn();
    });
    ...
    it('should set $__auto_interval_test', () => {
      var call = ctx.templateSrv.setLogDisplayPlatformVariable.mock.calls[0];
    ...
    it('should set $__auto_interval', () => {
      var call = ctx.templateSrv.setLogDisplayPlatformVariable.mock.calls.pop();
  ...
  describe('multiple interval variables with auto', () => {
    ...
    it('should correctly set $__auto_interval_variableX', () => {
      ...
      for (var i = 0; i < ctx.templateSrv.setLogDisplayPlatformVariable.mock.calls.length; i++) {
        var call = ctx.templateSrv.setLogDisplayPlatformVariable.mock.calls[i];
        switch (call[0]) {
