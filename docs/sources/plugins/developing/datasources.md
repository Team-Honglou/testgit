...
time series data so that any logdisplayplatform panel can then show it.

## Datasource development

> Our goal is not to have a very extensive documentation but rather have actual
> code that people can look at. An example implementation of a datasource can be
> found in this [example datasource repo](https://github.com/logdisplayplatform/simple-json-datasource)

To interact with the rest of logdisplayplatform the plugins module file can export 5 different components.
...
[
  {
    "annotation": {
      "name": "annotation name", //should match the annotation name in logdisplayplatform
      "enabled": true,
      "datasource": "generic datasource",
     },
