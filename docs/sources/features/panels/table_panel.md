+++
title = "Table Panel"
keywords = ["logdisplayplatform", "dashboard", "documentation", "panels", "table panel"]
type = "docs"
...
To view table panels in action and test different configurations with sample data, check out the [Table Panel Showcase in the LogDisplayPlatform Playground](http://play.logdisplayplatform.org/dashboard/db/table-panel-showcase).
...
> Only available in LogDisplayPlatform v5.0+.
