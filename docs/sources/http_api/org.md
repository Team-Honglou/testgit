...
description = "LogDisplayPlatform Organisation HTTP API"
keywords = ["logdisplayplatform", "http", "documentation", "api", "organisation"]
...
use Basic Auth and the LogDisplayPlatform user must have the LogDisplayPlatform Admin permission (The default admin user
