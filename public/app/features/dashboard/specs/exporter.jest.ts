...
describe('given dashboard with repeated panels', () => {
  ...
  it('should add logdisplayplatform version', () => {
    var require = _.find(exported.__requires, { name: 'LogDisplayPlatform' });
    expect(require.type).toBe('logdisplayplatform');
    expect(require.id).toBe('logdisplayplatform');
...
stubs['-- LogDisplayPlatform --'] = {
  name: '-- LogDisplayPlatform --',
  meta: {
    id: 'logdisplayplatform',
    info: { version: '1.2.1' },
    name: 'logdisplayplatform',
    builtIn: true,
  },
