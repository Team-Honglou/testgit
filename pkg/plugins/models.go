...
type PluginBase struct {
	...
	LogDisplayPlatformNetVersion   string `json:"-"`
	LogDisplayPlatformNetHasUpdate bool   `json:"-"`
}
...
func (pb *PluginBase) registerPlugin(pluginDir string) error {
	...
	if pb.Dependencies.LogDisplayPlatformVersion == "" {
		pb.Dependencies.LogDisplayPlatformVersion = "*"
	}
...
type PluginDependencies struct {
	LogDisplayPlatformVersion string                 `json:"logdisplayplatformVersion"`
